export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'deyavuz',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Deyavuz',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'deyavuz.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://deyavuz.com',
